...
interface SearcherProps {
  ...
  setStatusFilter: (value: "ALL" | "ACTIVA" | "INACTIVA") => void
  searchTerm: string
  disabled?: boolean
}

export default function SearcherCoseguroComponent({
  setSearchTerm,
  setStatusFilter,
  searchTerm,
  disabled,
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between p-1 rounded-xl">
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto">
        <Select
          defaultValue="ALL"
          onValueChange={(v) => setStatusFilter(v as "ALL" | "ACTIVA" | "INACTIVA")}
          disabled={disabled}
        >
