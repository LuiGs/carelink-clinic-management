  ...
  return (
    <div className="p-4 md:p-6">
      <div className="mx-auto max-w-3xl space-y-6 text-center">
        <div>
          <h1 className="mb-2 text-2xl font-semibold text-gray-900">Configuración</h1>
        ...
        <div className="rounded-lg border bg-white p-6 sm:p-8">
          ...
          <p className="mb-4 text-gray-600">Las opciones de configuración estarán disponibles pronto</p>
